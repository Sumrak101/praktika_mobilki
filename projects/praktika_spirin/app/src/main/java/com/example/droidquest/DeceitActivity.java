...
public class DeceitActivity extends AppCompatActivity {
    ...
    public  static final String EXTRA_ANSWER_IS_TRUE = "com.example.driodquest.answer_is_true";
    public  static final String EXTRA_ANSWER_IS_SHOWN = "com.example.driodquest.answer_shown";
